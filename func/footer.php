...
<footer id="footer" class="bg-black text-white py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-12">
                    <h4 class="font-size-20">Sadhannu</h4>
                    <p class="font-size-14  text-white-50">The Sadhannu website, create by php,
                        mysql database and bootstrap5.</p>
                </div>
                ...
                <div class="col-lg-2 col-12">
                    ...
                    <div class="d-flex flex-column flex-wrap">
                        ...
                        <a href="#" class="font-size-14 text-white-50 pb-1">Newsletter</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="copyright text-center py-2">
        <p class="font-size-14 my-0">&copy; Copyrights 2022. Desing By S & P</p>
    </div>
<!-- !start #footer -->
